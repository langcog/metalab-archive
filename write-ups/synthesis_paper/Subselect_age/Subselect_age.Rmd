...
subset <-bind_rows(gaze_following_age,idspref_age,inphondb_age[,1:116],inworddb_age,labadv_age[,1:116],
               mutex_age,phonotactics_age[,1:116],pointing_concurrent_age,pointing_longitudinal_age,
               sounds_age,symbolism_age,word_recognition_age)
