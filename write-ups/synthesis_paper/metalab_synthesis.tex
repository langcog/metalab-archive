...
%   \def\affinst{{"init", "Department of Psychology, Stanford University", "Laboratoire de Sciences Cognitives et Psycholinguistique, ENS", "NeuroPsychologie Interventionnelle (NPI), ENS"}}%
%   \def\affstate{{"init", "", "", ""}}%
%   \def\affcntry{{"init", "", "", ""}}%
...
thus sample sizes are small and studies are underpowered. In addition,
the high cost and practical difficulties associated with collecting
large developmental datasets means that replications are relatively rare
in the field.
...
\begin{table}[h!]
        ...
        \begin{tabular}{lp{8.4cm}r}
            \toprule
        \textbf{Level} & \textbf{Phenomenon}   & \textbf{N papers \newline (conditions)} \tabularnewline
        \midrule
        
        Prosody        & IDS  preference   {\scriptsize (Dunst, Gorman, \& Hamby, 2012)}               & 16 (50)     \\
        Sounds         & Phonotactic learning  {\scriptsize (Cristia, in prep.)}                       & 15 (47)                               \\
                ~              & Vowel discrimination (native) {\scriptsize (Tsuji \& Cristia, 2014)}          & 32 (143)             \\ 
        ~              & Vowel discrimination (non-native)  {\scriptsize (Tsuji \& Cristia, 2014)}      & 15 (48)     \\
                  ~             & Statistical sound learning  {\scriptsize (Cristia, in prep)}                  & 10 (18) \\ 
          ~             & Word segmentation  {\scriptsize  (Bergmann \& Cristia, 2015) }                 & 66 (291)     \\
          ~ &   Sound Symbolism {\scriptsize (Lammertink et al., 2016)} 
        & 10 (42)    \\     
        Words     &   Mutual exclusivity  {\scriptsize (Lewis \& Frank, in prep.)} 
        & 20 (60)             \\
        ~              & Concept-label advantage {\scriptsize (Lewis \& Long, unpublished)}         & 14 (49) \\
                ~              & Online word recognition  {\scriptsize (Frank, Lewis, \& MacDonald, 2016)}      & 6 (15)                         \\
        Communication  & Gaze following  {\scriptsize  (Frank, Lewis, \& MacDonald, 2016)}             & 12 (33)                                           \\
        ~              & Pointing and vocabulary {\scriptsize (Colonnesi et al., 2010)}               & 12 (12) \\
