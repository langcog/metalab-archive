...
sounds of their language to the meanings of words. Typically, these
skills are studied in isolation in separate research programs, but there
...
Demuth, Jones, \& Black, 2010; Shukla, White, \& Aslin, 2011) ). To
build an integrative theories of these dependencies, a whole-systems
view of the empirical landscape is needed. We suggest that meta-analytic
methods can support this goal, and provide a method for detecting bias
in the literature. Here we present meta-analyses of 12 phenomena in
language acquisition, with over 800 effect sizes. We find that the
literature generally has evidential value, and present a quantitative
synthesis of phenomena in language acquisition.}
...
aquisition, and at least prima facie inconsistent with stage-like
...
development. We then aggregate across phenemona to offer the first
