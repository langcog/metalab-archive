...
Vowel discrimination (native) & 0.59 [0.49, 0.7] & 9620 & 8.87 (p < .01) & -5.42 (p < .01)\\
Vowel discrimination (non-native) & 0.66 [0.42, 0.9] & 3391 & 4.13 (p < .01) & -3.24 (p < .01)\\
Statistical sound learning & -0.13 [-0.25, -0.01] & Inf & -1.47 (0.14) & -5.48 (p < .01)\\
Word segmentation & 0.2 [0.15, 0.25] & 5645 & 1.54 (0.12) & -9.67 (p < .01)\\
Mutual exclusivity & 1.01 [0.68, 1.33] & 6443 & 6.25 (p < .01) & -5 (p < .01)\\
Sound symbolism & 0.15 [0.04, 0.26] & 538 & -1.32 (0.19) & -2.16 (0.02)\\
Concept-label advantage & 0.4 [0.29, 0.51] & 3928 & 0.31 (0.76) & -6.15 (p < .01)\\
Online word recognition & 1.89 [0.81, 2.96] & 2843 & 2.92 (p < .01) & \\
...
1 Gaze following 33 2 Infant directed speech preference 50 3 Label
advantage in concept learning 100 4 Mutual exclusivity 60 5 Online word
recognition 15 6 Phonotactic learning 47 7 Pointing and vocabulary 30 8
Sound symbolism 42 9 Statistical sound category learning 40 10 Vowel
discrimination (native) 143 11 Vowel discrimination (non-native) 48 12
Word segmentation 291 \# A tibble: 0 x 4 \# \ldots{} with 4 variables:
dataset , n , num\_experiments , \# diff {[}1{]} dataset short\_cite
participant\_design {[}4{]} n\_1 n\_2 mean\_age\_1\\
 {[}7{]} mean\_age\_2 x\_1 x\_2\\
{[}10{]} SD\_1 SD\_2 t\\
{[}13{]} F\\
\textless{}0 rows\textgreater{} (or 0-length row.names) \# A tibble: 15
x 72 study\_ID 1 fernald2006 2 fernald2006 3 fernald2006 4 fernald2006 5
fernald2012 6 fernald2012 7 fernald2013 8 fernald2013 9 fernald2013 10
fernald2013 11 fernald2006b 12 fernald2006b 13 hurtado2007 14
hurtado2007 15 zangl2005 \# \ldots{} with 71 more variables: long\_cite
, short\_cite , \# peer\_reviewed , coder , expt\_num , \#
expt\_condition , same\_infant , response\_mode , \# exposure\_phase ,
method , dependent\_measure , \# participant\_design , native\_lang ,
infant\_type , \# group\_name\_1 , group\_name\_2 , n\_1 , n\_2 , \#
mean\_age\_1 , mean\_age\_2 , x\_1 , x\_2 , SD\_1 , \# SD\_2 , t , F , d
, d\_var , corr , \# test\_lang , stimuli\_link , data\_link , \#
age\_range\_1 , age\_range\_2 , n\_excluded\_1 , \# n\_excluded\_2 ,
gender\_1 , gender\_2 , num\_trials , \# special\_cases\_measures ,
x\_dif , SD\_dif , r , \# contrast\_sampa , audio\_condition , speaker ,
\# speech\_type , object\_stimulus , cue\_type , N\_AFC , \#
mean\_comprehension\_vocab , mean\_production\_vocab , \# corr\_imputed
, d\_calc , d\_var\_calc , g\_calc , \# g\_var\_calc , r\_calc ,
r\_var\_calc , z\_calc , \# z\_var\_calc , log\_odds\_calc ,
log\_odds\_var\_calc , \# dataset , short\_name , mean\_age , n , \#
filename , year , all\_mod , mean\_age\_months
