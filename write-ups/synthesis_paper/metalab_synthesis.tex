...
%   \def\affinst{{"init", "Department of Psychology, Stanford University", "Department of Brain and Cognitive Sciences, MIT", "Laboratoire de Sciences Cognitives et Psycholinguistique, ENS", "NeuroPsychologie Interventionnelle, ENS"}}%
%   \def\affstate{{"init", "", "", "", ""}}%
%   \def\affcntry{{"init", "", "", "", ""}}%
...
typically studied in isolation in separate research programs, but there
is a growing body of evidence that these skills may depend on each other
(e.g., Feldman, Myers, White, Griffiths, \& Morgan, 2013; Johnson,
Demuth, Jones, \& Black, 2010; Shukla, White, \& Aslin, 2011). We
suggest that the meta-analytic method can support the process of
building theories that take a systems-level perspective, as well as
provide a tool for detecting bias in a literature. Here we present
meta-analyses of 12 phenomena in language acquisition, with over 800
...
studies is likely to be less biased than qualitative methods (Valentine,
