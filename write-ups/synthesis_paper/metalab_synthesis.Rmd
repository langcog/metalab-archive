...
simulated.development = data.frame(age.years = c(x,x,x,x,x,x,x,x,x),
                                   ...
                                   model = rep(c("Bottom-up", "Interactive", "Ad hoc"), each=length(x)*3),
                                   n = 1,
                                   d_var_calc = NA)
