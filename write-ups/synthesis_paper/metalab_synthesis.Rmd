...
simulated.development.all = mutate(simulated.development, dataset = as.factor(dataset)) %>%
  rbind(all_data.f) %>%
  mutate(model = ordered(model, levels = c("Bottom-up", "Interactive", "Ad hoc", "Observed")))
