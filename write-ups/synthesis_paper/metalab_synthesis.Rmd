...
# kable(table.data, format = "latex", booktabs = TRUE) # paste below (so can edit latex - e.g. fix p = 0)
...
Statistical sound learning & -0.13 [-0.25, -0.01] & *n.a.* & -1.47 (0.14) & -5.48 (<.01)\\
...
TO DO:
  ...
  - do something with Alex's sounds MA?
  - check pointing
