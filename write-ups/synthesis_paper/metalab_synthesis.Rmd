...
abstract: To acquire a language, children must learn a range of skills, from the sounds of their language to the meanings of words. These skills are typically studied in isolation in separate research programs, but there is a growing body of evidence that these skills may depend on each other (e.g., Feldman, Myers, White, Griffiths, & Morgan, 2013; Johnson, Demuth, Jones, & Black, 2010; Shukla, White, & Aslin, 2011). However, to understand these dependencies, a whole-systems view of the empirical landscape is needed. We suggest that meta-analytic methods can support this goal, and provide a method for detecting bias in the literature. Here we present meta-analyses of 12 phenomena in language acquisition, with over 800 effect sizes. We find that the language acquisition literature overall has evidential value, and present a quantitative synthesis of phenomena that suggests a high-degree of interactivity across the language acquistion system.
...
legend.desc2 = simulated.development.all %>%
  ...
  mutate(dataset.label = droplevels.factor(dataset.label),
  dataset.label = gdata::reorder.factor(dataset.label, 
                                    new.order = rev(c(6,5,4,10,9,7,8,2,1,3))))%>%
