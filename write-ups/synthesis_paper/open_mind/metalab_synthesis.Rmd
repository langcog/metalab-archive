...
representation and processing (Metalab; [ http://metalab.stanford.edu](http://metalab.stanford.edu); see Table 1 for description of phenomena). We use this dataset to demonstrate
...
This analysis provides a quantitative estimate of the size of an effect in an intuitive unit, but it does not assess analytical or publication bias [@scargle1999publication]. Importantly, if experimenters are selectively reporting results, then the number and magnitude of observed true e ects in the literature may be greatly inflated. In the next analysis, we assess the presence of bias through funnel plots.
...
table.data = left_join(select(all_ds, c(short_name, d_string)), fsn.package.data) %>%
             ...
             mutate(dataset = fct_recode(dataset,"IDS preference" = "Infant directed speech preference",
              ...
              mutate(egg_string = sub("(0)", "(< .01)", egg_string, fixed = T),
                     ...
                     fsn_string = sub("Inf", "$\\dagger$", fsn_string)) 
...
ML, ST, CB, PP, AC, and MF wrote the paper. ML, ST, CB, AC, and MF coded papers for the meta-analytic dataset. All authors contributed to data analysis. MB, MF, and ML developed the Metalab website infrastructure.
