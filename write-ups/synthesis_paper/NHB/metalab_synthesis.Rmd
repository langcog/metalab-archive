...
note: |  
  email: mollylewis@uchicago.edu; ML, ST, CB, PP, AC, and MF wrote the paper. ML, ST, CB, AC, and MF coded papers for the meta-analytic dataset. All authors contributed to data analysis. MB, MF, and ML developed the Metalab website infrastructure.  
...
# to do: fix citation issue, fix figure position, compare to pnas for content, fix statements at end
```
...
The data and code reported in this paper have been deposited in GiHhub, a web-based repository hosting service, 
...
This article contains supporting information online at http://rpubs.com/mll/synthesisSI
