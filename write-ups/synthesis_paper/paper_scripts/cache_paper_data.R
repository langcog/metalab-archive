...
# the data to be used for the paper in ../paper_data/. To run this file, from main
# dir: Rscript write-ups/synthesis_paper/paper_analysis_scripts/cache_paper_data.R
...
synthesis_paper_all_data <- filter(all_data, short_name %in% MAS) %>%
