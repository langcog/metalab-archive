...
all_data_preds <- all_data %>%
  select(dataset, short_name, d_calc, d_var_calc, mean_age, unique_ID) %>%
...
multiage_data <- multiage_data %>%
  ungroup %>%
  select(dataset, short_name, unique_ID, d_calc, mean_age, d_var_calc, lin_log_pred) %>%
